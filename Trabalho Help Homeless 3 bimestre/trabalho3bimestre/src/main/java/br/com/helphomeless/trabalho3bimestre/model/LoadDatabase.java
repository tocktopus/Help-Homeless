...
public class LoadDatabase {
    ...
    CommandLineRunner initDataBase(DoadorRepository repository){
        return args -> {
            ...
            Doador doador1 = new Doador("Mirela Oliveira", "mirela@gmail.com", "mimi123");
            ...
            Doador doador2 = new Doador("Luiz Santos", "lulu@gmail.com", "todaformadeamor");

            doacoes = new ArrayList<>();

            doacao1 = new Doacao(500.00, Date.valueOf("2021-09-30"));
